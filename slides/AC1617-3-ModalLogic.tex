...
\text{\blue{there exists}}\; v \in W \;\text{st}\; w R_m v\; \text{and}\; \ger{M}, v \models \phi\\
\ger{M}, w & \models \nc{m}{\phi} & \text{~~~ \textsf{iff} ~~~} &
\text{\blue{for all}}\; v \in W \; \text{st}\; w R_m v\; \text{and}\; \ger{M}, v \models \phi\\
\end{align*}
\end{block}
\end{slide}
...
mutual exclusion  & $\dgold{\forall} \dkb{\always} (\neg c_1 \vee \neg c_2)$ \\
 liveness & $\dgold{\forall} \dkb{\always} \dgold{\forall} \dkb{\eventual} c_1 \wedge \dgold{\forall} \dkb{\always} \dgold{\forall}  \dkb{\eventual} c_2$\\
